...
<!--  body  --------------------->
  <body style="background-color: #202020;">
     <div class="wrap">
      ...
      <div id="line-2" >
        <nav class="nav2">
          <a class="nav-link2" href="./1.tving.html"><img class="ott_icon" src="${path}/resources/images/icon/티빙.png" alt="tving" style="border: 3px solid #33ff33; border-radius: 15px;" border-radius: 15px ;></a>
          <a class="nav-link2" href="./2.netflix.html"><img class="ott_icon" src="${path}/resources/images/icon/netplix.png" alt="netflix"></a>
          <a class="nav-link2" href="./3.wavve.html"><img class="ott_icon" src="${path}/resources/images/icon/웨이브.png" alt="wavve"></a>
