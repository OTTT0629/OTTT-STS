     ...
     <div class="wrap">
      ...
      <div id="line-2" >
        <nav class="nav2">
          ...
          <a class="nav-link2" href="./6.disney.html"><img class="ott_icon" src="${path}/resources/images/icon/디즈니플러스.png" alt="disney" style="border: 3px solid #33ff33; border-radius: 15px;"></a>
        </nav>
      </div>
