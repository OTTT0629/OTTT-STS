     ...
     <div class="wrap">
      ...
      <div id="line-2" >
        <nav class="nav2">
          ...
          <a class="nav-link2" href="./2.netflix.html"><img class="ott_icon" src="${path}/resources/images/icon/netplix.png" alt="netflix" style="border: 3px solid #33ff33; border-radius: 15px;"></a>
