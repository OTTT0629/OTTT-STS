     ...
     <div class="wrap">
      ...
      <div id="line-2" >
        <nav class="nav2">
          ...
          <a class="nav-link2" href="./5.watcha.html"><img class="ott_icon" src="${path}/resources/images/icon/왓챠.png" alt="watcha" style="border: 3px solid #33ff33; border-radius: 15px;"></a>
