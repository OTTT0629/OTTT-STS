...
<!--++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->
          <div class="Rcontent" >
            <div class="maintext">
              <div class="post_info" >
                <ul style="display: flex;">
                  ...
                  <li>
                    <a class="nickname_main" href="#">nickname</a>
                  </li>
                  <li>
            ...
            <div class="wirted">
                ...
                <img class="poster" src="./images/스즈메포스터.png" alt="poster">
                <p id="current_date" >작성한 날짜</p>
            </div>
            <div class="pro-total">
                <div class="pro-info">
                    <input class="heart" type="image" src="./images/heart.png" alt="heart">
                    <p> 4</p> 
                    <input class="re_comment_img" type="image" src="./images/comment.png" alt="대댓글">
                    <p> 5</p>
                    </div>
        ...
        <!--댓글-->
            <ul class="Comment">
              <li class="comment_write">
                <a href="../ottt박소율/mypageshow.html"><img class="profile" src="./images/Pikachu.png" alt="profile" ></a>
                <a class="nickname" href="../ottt박소율/mypageshow.html">피카츄</a>
                <div>
                <textarea class="writeHere" placeholder="Write Here" onkeydown="resize(this)" onkeyup="resize(this)" ></textarea>
                <input class="btn_commit" type="image" src="./images/commit.png" alt="commit">
                </div>
              </li>
              <li class="comment_show">
                <div>
                  <a href="../ottt박소율/mypageshow.html"><img class="profile" src="./images/user-h.png" alt="profile" ></a>
